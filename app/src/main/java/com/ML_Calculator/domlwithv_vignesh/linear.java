...
public class linear<gif> extends AppCompatActivity {
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.linreg;
    ...
    public void gif(){
        ...
        Glide.with(linear.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view){
        ...
        if (!str1.equals("")) {
            ...
            pyattr = splash_screen.pyobj.callAttr("linear", str1, str2, str3);
            ...
            out1.setText(val.get(0).toString());
            grp1 = (ImageView) findViewById(R.id.grp1);
                    ...
                    if (err.equals("error")) {
                        ...
                        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                            ...
                            public void onGlobalLayout() {
                                ...
                                int width = sc.getMeasuredWidth() - 100;
