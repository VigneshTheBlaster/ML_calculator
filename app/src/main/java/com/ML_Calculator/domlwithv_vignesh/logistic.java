...
public class logistic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb.setText("Logistic regression");
        ...
        ArrayAdapter<String> my_adpt = new ArrayAdapter<String>(logistic.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.testing_method));
        ...
        ArrayAdapter<String> my_adpt1 = new ArrayAdapter<String>(logistic.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.sty));
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.lr;
    ...
    public void gif(){
        ...
        Glide.with(logistic.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view){
        ...
        if (!str1.equals("")) {
            ...
            pyattr = splash_screen.pyobj.callAttr("logreg", str1, str2, str4, str5, str6, str7, str8, str9, str3);
