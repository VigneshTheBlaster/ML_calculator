...
public class NaiveBayes_str extends AppCompatActivity {

    PyObject pyattr;
    TextView X1,y1,p1,ts,rs;
    ImageView gif,demo;
    VideoView vv;
    int pls=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_naive_bayes_str);
        AdView adView = findViewById(R.id.adView);
        AdRequest adRequest=new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        TextView tb=(TextView)findViewById(R.id.textView);
        tb.setText("Naive bayes(Str)");
        ...
        ArrayAdapter<String> my_adpt = new ArrayAdapter<String>(NaiveBayes_str.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.nbs));
        ...
        ArrayAdapter<String> my_adpt1 = new ArrayAdapter<String>(NaiveBayes_str.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.sty));
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.navstr;
    ...
    public void gif(){
        ...
        Glide.with(NaiveBayes_str.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view){
        ...
        if (!str1.equals("")) {
            ...
            pyattr = splash_screen.pyobj.callAttr("navs", str1, str2, str4, str5, str6, str7, str9);
