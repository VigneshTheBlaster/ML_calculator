...
public class densityc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_densityc);
        AdView adView = findViewById(R.id.adView);
        AdRequest adRequest=new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        TextView tb=(TextView)findViewById(R.id.textView);
        tb.setText("Density-based cluster");
        ...
        ArrayAdapter<String> my_adpt1 = new ArrayAdapter<String>(densityc.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.yn));
        ...
        ArrayAdapter<String> my_adpt4 = new ArrayAdapter<String>(densityc.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.dm));
        ...
        ArrayAdapter<String> my_adpt8 = new ArrayAdapter<String>(densityc.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.yn));
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.dbc;
    ...
    public void gif(){
        ...
        Glide.with(densityc.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view) {
        ...
        if (!str1.equals("")) {
            ...
            the = (TextView) findViewById(R.id.ms);
            ...
            pyattr = splash_screen.pyobj.callAttr("dbc", str1, str6, str3, str5, str15, str4, str9);
