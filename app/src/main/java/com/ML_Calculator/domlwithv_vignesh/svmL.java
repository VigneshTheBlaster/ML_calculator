...
public class svmL extends AppCompatActivity {

    PyObject pyattr;
    TextView X1,y1,p1,the,ts,rs,cv,ite;
    ImageView gif,demo;
    VideoView vv;
    int pls=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> my_adpt = new ArrayAdapter<String>(svmL.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.testing_method));
        ...
        ArrayAdapter<String> my_adpt1 = new ArrayAdapter<String>(svmL.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.sty));
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.svml;
    ...
    public void gif(){
        ...
        Glide.with(svmL.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view){
        ...
        if (!str1.equals("")) {
            ...
            String str10 = ite.getText().toString();
            pyattr = splash_screen.pyobj.callAttr("svml", str1, str2, str3, str10, str4, str5, str6, str7, str8, str9);
