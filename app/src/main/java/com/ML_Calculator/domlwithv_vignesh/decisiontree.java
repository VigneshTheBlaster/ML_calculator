...
public class decisiontree extends AppCompatActivity {
    ...
    PyObject pyattr;
    TextView X1,p1,ts,rs,msl,mln,ccv,sr,st,pre;
    ImageView gif,demo;
    VideoView vv;
    int pls=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> my_adpt = new ArrayAdapter<String>(decisiontree.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.testing_method));
        ...
        ArrayAdapter<String> my_adpt1 = new ArrayAdapter<String>(decisiontree.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.sty));
        ...
        ArrayAdapter<String> my_adpt2 = new ArrayAdapter<String>(decisiontree.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.ct));
        ...
        ArrayAdapter<String> my_adpt3 = new ArrayAdapter<String>(decisiontree.this, R.layout.vicky_spinner,getResources().getStringArray(R.array.sc));
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.dt;
    ...
    public void gif(){
        ...
        Glide.with(decisiontree.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view){
        ...
        if (!str1.equals("")) {
            ...
            pyattr = splash_screen.pyobj.callAttr("dt", str1, str9, str6, str4, str17, str16, str18, str5, str7, str8, str10, str11, str12, str13);
                        ...
                        if (!val.get(2).toString().equals("")) {
                            ...
                            vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                                ...
                                public void onGlobalLayout() {
                                    sc.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                                    int width = sc.getMeasuredWidth() - 105;
                                    byte data[] = android.util.Base64.decode(val.get(2).toString(), Base64.DEFAULT);
                                    Bitmap bmp = BitmapFactory.decodeByteArray(data, 0, data.length);
                                    grp2.setImageBitmap(bmp);
                                    grp2.setVisibility(View.VISIBLE);
