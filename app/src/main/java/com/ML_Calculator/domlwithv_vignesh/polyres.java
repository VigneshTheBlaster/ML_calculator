...
public class polyres extends AppCompatActivity {

    PyObject pyattr;
    TextView X1,y1,p1,dox;
    ImageView gif,demo;
    VideoView vv;
    int pls=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polyres);
        AdView adView = findViewById(R.id.adView);
        AdRequest adRequest=new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        TextView tb=(TextView)findViewById(R.id.textView);
        tb.setText("polynomial regression");
    ...
    public void ply(View v){
        ...
        if (pls==1){
            ...
            String str = "android.resource://" + getPackageName() + "/" + R.raw.pr;
    ...
    public void gif(){
        ...
        Glide.with(polyres.this).asGif().load(R.raw.finalgif).into(gif);
    }
    ...
    public void build1(View view) {
        ...
        if (!str1.equals("")) {
            ...
            dox = (TextView) findViewById(R.id.dox);
            String str2 = y1.getText().toString();
            String str3 = p1.getText().toString();
            String str4 = dox.getText().toString();
            pyattr = splash_screen.pyobj.callAttr("polylinear", str1, str2, str4, str3);
